...
load_all_textures :: proc(renderer: ^Renderer) {
	...
	texture_paths["tilemap_texture_atlas"] = "./assets/textures/tilemap_texture_atlas.png"
	texture_paths["entity_texture_atlas"] = "./assets/textures/entity_texture_atlas.png"
